...
void DiJetNtuplizer::beginJob()
{
  ...
  h_PassSelPF_ = new TH1D("h_PassSelectionPF", "Selection Pass Failures PFJets",
			  200, -0.5, 199.5);

  tree_ = new TTree("dijettree", "tree for dijet balancing");

  tree_->Branch("tjet_pt", &tpfjet_pt_, "tjet_pt/F");
  tree_->Branch("tjet_p", &tpfjet_p_, "tjet_p/F");
  tree_->Branch("tjet_E", &tpfjet_E_, "tjet_E/F");
  tree_->Branch("tjet_eta", &tpfjet_eta_, "tjet_eta/F");
  tree_->Branch("tjet_phi", &tpfjet_phi_, "tjet_phi/F");
  tree_->Branch("tjet_EMfrac", &tpfjet_EMfrac_, "tjet_EMfrac/F");
  tree_->Branch("tjet_hadEcalEfrac", &tpfjet_hadEcalEfrac_,
		"tjet_hadEcalEfrac/F");
  tree_->Branch("tjet_scale", &tpfjet_scale_, "tjet_scale/F");
  tree_->Branch("tjet_area", &tpfjet_area_, "tjet_area/F");
  tree_->Branch("tjet_jetID", &tpfjet_jetID_, "tjet_jetID/I");
  if(doGenJets_){
    tree_->Branch("tjet_genpt", &tpfjet_genpt_, "tjet_genpt/F");
    tree_->Branch("tjet_genp", &tpfjet_genp_, "tjet_genp/F");
    tree_->Branch("tjet_genE", &tpfjet_genE_, "tjet_genE/F");
    tree_->Branch("tjet_gendr", &tpfjet_gendr_, "tjet_gendr/F");
  }
  tree_->Branch("tjet_unkown_E", &tpfjet_unkown_E_, "tjet_unkown_E/F");
  tree_->Branch("tjet_electron_E", &tpfjet_electron_E_, "tjet_electron_E/F");
  tree_->Branch("tjet_muon_E", &tpfjet_muon_E_, "tjet_muon_E/F");
  tree_->Branch("tjet_photon_E", &tpfjet_photon_E_, "tjet_photon_E/F");
  tree_->Branch("tjet_unkown_px", &tpfjet_unkown_px_, "tjet_unkown_px/F");
  tree_->Branch("tjet_electron_px", &tpfjet_electron_px_, "tjet_electron_px/F");
  tree_->Branch("tjet_muon_px", &tpfjet_muon_px_, "tjet_muon_px/F");
  tree_->Branch("tjet_photon_px", &tpfjet_photon_px_, "tjet_photon_px/F");
  tree_->Branch("tjet_unkown_py", &tpfjet_unkown_py_, "tjet_unkown_py/F");
  tree_->Branch("tjet_electron_py", &tpfjet_electron_py_, "tjet_electron_py/F");
  tree_->Branch("tjet_muon_py", &tpfjet_muon_py_, "tjet_muon_py/F");
  tree_->Branch("tjet_photon_py", &tpfjet_photon_py_, "tjet_photon_py/F");
  tree_->Branch("tjet_unkown_pz", &tpfjet_unkown_pz_, "tjet_unkown_pz/F");
  tree_->Branch("tjet_electron_pz", &tpfjet_electron_pz_, "tjet_electron_pz/F");
  tree_->Branch("tjet_muon_pz", &tpfjet_muon_pz_, "tjet_muon_pz/F");
  tree_->Branch("tjet_photon_pz", &tpfjet_photon_pz_, "tjet_photon_pz/F");
  tree_->Branch("tjet_unkown_EcalE", &tpfjet_unkown_EcalE_,
		"tjet_unkown_EcalE/F");
  tree_->Branch("tjet_electron_EcalE", &tpfjet_electron_EcalE_,
		"tjet_electron_EcalE/F");
  tree_->Branch("tjet_muon_EcalE", &tpfjet_muon_EcalE_, "tjet_muon_EcalE/F");
  tree_->Branch("tjet_photon_EcalE", &tpfjet_photon_EcalE_,
		"tjet_photon_EcalE/F");
  tree_->Branch("tjet_unkown_n", &tpfjet_unkown_n_, "tjet_unkown_n/I");
  tree_->Branch("tjet_electron_n", &tpfjet_electron_n_, "tjet_electron_n/I");
  tree_->Branch("tjet_muon_n", &tpfjet_muon_n_, "tjet_muon_n/I");
  tree_->Branch("tjet_photon_n", &tpfjet_photon_n_, "tjet_photon_n/I");
  tree_->Branch("tjet_had_n", &tpfjet_had_n_, "tjet_had_n/I");
  tree_->Branch("tjet_had_E", &tpfjet_had_E_);
  tree_->Branch("tjet_had_px", &tpfjet_had_px_);
  tree_->Branch("tjet_had_py", &tpfjet_had_py_);
  tree_->Branch("tjet_had_pz", &tpfjet_had_pz_);
  tree_->Branch("tjet_had_EcalE", &tpfjet_had_EcalE_);
  tree_->Branch("tjet_had_rawHcalE", &tpfjet_had_rawHcalE_);
  tree_->Branch("tjet_had_emf", &tpfjet_had_emf_);
  tree_->Branch("tjet_had_id", &tpfjet_had_id_);
  tree_->Branch("tjet_had_candtrackind", &tpfjet_had_candtrackind_);
  if(doGenJets_){
    tree_->Branch("tjet_had_E_mctruth", &tpfjet_had_E_mctruth_);
    tree_->Branch("tjet_had_mcpdgId", &tpfjet_had_mcpdgId_);
  }
  tree_->Branch("tjet_had_ntwrs", &tpfjet_had_ntwrs_);
  tree_->Branch("tjet_ntwrs", &tpfjet_ntwrs_, "tjet_ntwrs/I");
  tree_->Branch("tjet_twr_ieta", &tpfjet_twr_ieta_);
  tree_->Branch("tjet_twr_iphi", &tpfjet_twr_iphi_);
  tree_->Branch("tjet_twr_depth", &tpfjet_twr_depth_);
  tree_->Branch("tjet_twr_subdet", &tpfjet_twr_subdet_);
  tree_->Branch("tjet_twr_hade", &tpfjet_twr_hade_);
  tree_->Branch("tjet_twr_frac", &tpfjet_twr_frac_);
  tree_->Branch("tjet_twr_candtrackind", &tpfjet_twr_candtrackind_);
  tree_->Branch("tjet_twr_hadind", &tpfjet_twr_hadind_);
  tree_->Branch("tjet_twr_elmttype", &tpfjet_twr_elmttype_);
  tree_->Branch("tjet_twr_dR", &tpfjet_twr_dR_);
  tree_->Branch("tjet_twr_clusterind", &tpfjet_twr_clusterind_);
  tree_->Branch("tjet_cluster_n", &tpfjet_cluster_n_, "tjet_cluster_n/I");
  tree_->Branch("tjet_cluster_eta", &tpfjet_cluster_eta_);
  tree_->Branch("tjet_cluster_phi", &tpfjet_cluster_phi_);
  tree_->Branch("tjet_cluster_dR", &tpfjet_cluster_dR_);
  tree_->Branch("tjet_ncandtracks", &tpfjet_ncandtracks_, "tjet_ncandtracks/I");
  tree_->Branch("tjet_candtrack_px", &tpfjet_candtrack_px_);
  tree_->Branch("tjet_candtrack_py", &tpfjet_candtrack_py_);
  tree_->Branch("tjet_candtrack_pz", &tpfjet_candtrack_pz_);
  tree_->Branch("tjet_candtrack_EcalE", &tpfjet_candtrack_EcalE_);
  tree_->Branch("pjet_pt", &ppfjet_pt_, "pjet_pt/F");
  tree_->Branch("pjet_p", &ppfjet_p_, "pjet_p/F");
  tree_->Branch("pjet_E", &ppfjet_E_, "pjet_E/F");
  tree_->Branch("pjet_eta", &ppfjet_eta_, "pjet_eta/F");
  tree_->Branch("pjet_phi", &ppfjet_phi_, "pjet_phi/F");
  tree_->Branch("pjet_EMfrac", &ppfjet_EMfrac_, "pjet_EMfrac/F");
  tree_->Branch("pjet_hadEcalEfrac", &ppfjet_hadEcalEfrac_,
		"pjet_hadEcalEfrac/F");
  tree_->Branch("pjet_scale", &ppfjet_scale_, "pjet_scale/F");
  tree_->Branch("pjet_area", &ppfjet_area_, "pjet_area/F");
  tree_->Branch("pjet_jetID", &ppfjet_jetID_, "pjet_jetID/I");
  if(doGenJets_){
    tree_->Branch("pjet_genpt", &ppfjet_genpt_, "pjet_genpt/F");
    tree_->Branch("pjet_genp", &ppfjet_genp_, "pjet_genp/F");
    tree_->Branch("pjet_genE", &ppfjet_genE_, "pjet_genE/F");
    tree_->Branch("pjet_gendr", &ppfjet_gendr_, "pjet_gendr/F");
  }
  tree_->Branch("pjet_unkown_E", &ppfjet_unkown_E_, "pjet_unkown_E/F");
  tree_->Branch("pjet_electron_E", &ppfjet_electron_E_, "pjet_electron_E/F");
  tree_->Branch("pjet_muon_E", &ppfjet_muon_E_, "pjet_muon_E/F");
  tree_->Branch("pjet_photon_E", &ppfjet_photon_E_, "pjet_photon_E/F");
  tree_->Branch("pjet_unkown_px", &ppfjet_unkown_px_, "pjet_unkown_px/F");
  tree_->Branch("pjet_electron_px", &ppfjet_electron_px_, "pjet_electron_px/F");
  tree_->Branch("pjet_muon_px", &ppfjet_muon_px_, "pjet_muon_px/F");
  tree_->Branch("pjet_photon_px", &ppfjet_photon_px_, "pjet_photon_px/F");
  tree_->Branch("pjet_unkown_py", &ppfjet_unkown_py_, "pjet_unkown_py/F");
  tree_->Branch("pjet_electron_py", &ppfjet_electron_py_, "pjet_electron_py/F");
  tree_->Branch("pjet_muon_py", &ppfjet_muon_py_, "pjet_muon_py/F");
  tree_->Branch("pjet_photon_py", &ppfjet_photon_py_, "pjet_photon_py/F");
  tree_->Branch("pjet_unkown_pz", &ppfjet_unkown_pz_, "pjet_unkown_pz/F");
  tree_->Branch("pjet_electron_pz", &ppfjet_electron_pz_, "pjet_electron_pz/F");
  tree_->Branch("pjet_muon_pz", &ppfjet_muon_pz_, "pjet_muon_pz/F");
  tree_->Branch("pjet_photon_pz", &ppfjet_photon_pz_, "pjet_photon_pz/F");
  tree_->Branch("pjet_unkown_EcalE", &ppfjet_unkown_EcalE_,
		"pjet_unkown_EcalE/F");
  tree_->Branch("pjet_electron_EcalE", &ppfjet_electron_EcalE_,
		"pjet_electron_EcalE/F");
  tree_->Branch("pjet_muon_EcalE", &ppfjet_muon_EcalE_, "pjet_muon_EcalE/F");
  tree_->Branch("pjet_photon_EcalE", &ppfjet_photon_EcalE_,
		"pjet_photon_EcalE/F");
  tree_->Branch("pjet_unkown_n", &ppfjet_unkown_n_, "pjet_unkown_n/I");
  tree_->Branch("pjet_electron_n", &ppfjet_electron_n_, "pjet_electron_n/I");
  tree_->Branch("pjet_muon_n", &ppfjet_muon_n_, "pjet_muon_n/I");
  tree_->Branch("pjet_photon_n", &ppfjet_photon_n_, "pjet_photon_n/I");
  tree_->Branch("pjet_had_n", &ppfjet_had_n_, "pjet_had_n/I");
  tree_->Branch("pjet_had_E", &ppfjet_had_E_);
  tree_->Branch("pjet_had_px", &ppfjet_had_px_);
  tree_->Branch("pjet_had_py", &ppfjet_had_py_);
  tree_->Branch("pjet_had_pz", &ppfjet_had_pz_);
  tree_->Branch("pjet_had_EcalE", &ppfjet_had_EcalE_);
  tree_->Branch("pjet_had_rawHcalE", &ppfjet_had_rawHcalE_);
  tree_->Branch("pjet_had_emf", &ppfjet_had_emf_);
  tree_->Branch("pjet_had_id", &ppfjet_had_id_);
  tree_->Branch("pjet_had_candtrackind", &ppfjet_had_candtrackind_);
  if(doGenJets_){
    tree_->Branch("pjet_had_E_mctruth", &ppfjet_had_E_mctruth_);
    tree_->Branch("pjet_had_mcpdgId", &ppfjet_had_mcpdgId_);
  }
  tree_->Branch("pjet_had_ntwrs", &ppfjet_had_ntwrs_);
  tree_->Branch("pjet_ntwrs", &ppfjet_ntwrs_, "pjet_ntwrs/I");
  tree_->Branch("pjet_twr_ieta", &ppfjet_twr_ieta_);
  tree_->Branch("pjet_twr_iphi", &ppfjet_twr_iphi_);
  tree_->Branch("pjet_twr_depth", &ppfjet_twr_depth_);
  tree_->Branch("pjet_twr_subdet", &ppfjet_twr_subdet_);
  tree_->Branch("pjet_twr_hade", &ppfjet_twr_hade_);
  tree_->Branch("pjet_twr_frac", &ppfjet_twr_frac_);
  tree_->Branch("pjet_twr_candtrackind", &ppfjet_twr_candtrackind_);
  tree_->Branch("pjet_twr_hadind", &ppfjet_twr_hadind_);
  tree_->Branch("pjet_twr_elmttype", &ppfjet_twr_elmttype_);
  tree_->Branch("pjet_twr_dR", &ppfjet_twr_dR_);
  tree_->Branch("pjet_twr_clusterind", &ppfjet_twr_clusterind_);
  tree_->Branch("pjet_cluster_n", &ppfjet_cluster_n_, "pjet_cluster_n/I");
  tree_->Branch("pjet_cluster_eta", &ppfjet_cluster_eta_);
  tree_->Branch("pjet_cluster_phi", &ppfjet_cluster_phi_);
  tree_->Branch("pjet_cluster_dR", &ppfjet_cluster_dR_);
  tree_->Branch("pjet_ncandtracks", &ppfjet_ncandtracks_, "pjet_ncandtracks/I");
  tree_->Branch("pjet_candtrack_px", &ppfjet_candtrack_px_);
  tree_->Branch("pjet_candtrack_py", &ppfjet_candtrack_py_);
  tree_->Branch("pjet_candtrack_pz", &ppfjet_candtrack_pz_);
  tree_->Branch("pjet_candtrack_EcalE", &ppfjet_candtrack_EcalE_);
  tree_->Branch("dijet_deta", &pf_dijet_deta_, "dijet_deta/F");
  tree_->Branch("dijet_dphi", &pf_dijet_dphi_, "dijet_dphi/F");
  tree_->Branch("dijet_balance", &pf_dijet_balance_, "dijet_balance/F");
  tree_->Branch("thirdjet_px", &pf_thirdjet_px_, "thirdjet_px/F");
  tree_->Branch("thirdjet_py", &pf_thirdjet_py_, "thirdjet_py/F");
  tree_->Branch("thirdjet_px_uncorr", &pf_thirdjet_px_uncorr_,
		"thirdjet_px_uncorr/F");
  tree_->Branch("thirdjet_py_uncorr", &pf_thirdjet_py_uncorr_,
		"thirdjet_py_uncorr/F");
  tree_->Branch("Run", &pf_Run_, "Run/I");
  tree_->Branch("Lumi", &pf_Lumi_, "Lumi/I");
  tree_->Branch("Event", &pf_Event_, "Event/I");
  tree_->Branch("NPV", &pf_NPV_, "NPV/I");
  if(doGenJets_){
    tree_->Branch("weight", &pf_weight_, "weight/F");
  }
